export const BASENAME = '/airQualityIndexDataVisulization'; // don't add '/' at end off BASENAME
export const BASE_URL = '/charts/nvd3';
export const BASE_TITLE = 'Air Quality Index data visulation';
